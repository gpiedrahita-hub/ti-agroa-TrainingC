/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 9d35a6948fe1a5ed3a08482b8a05b60a)
...
declare namespace Cloudflare {
	interface Env {
		...
		NODE_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* infinite-herbs-app */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "JWT_SECRET" | "NEXT_PUBLIC_SITE_NAME" | "NEXT_PUBLIC_API_MODE" | "NEXT_PUBLIC_API_TIMEOUT" | "NODE_ENV">> {}
}
